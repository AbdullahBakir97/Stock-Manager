...
def get_button_icon(icon_name: str) -> QIcon:
    ...
    icon_map = {
        ...
        "power": "icons/power_icon.svg",
        "close": "icons/close_square_icon_184289.svg",
        "receipt": "icons/receipt_icon.svg",
        "chart": "icons/chart_icon_184274.svg",
        "graph": "icons/graph_icon_184279.svg",
        "toggle": "icons/toggle_icon.svg",
    }
...
def get_colored_icon(icon_name: str, hex_color: str) -> QIcon:
    """Get QIcon recolored to a specific color (e.g. for semantic action buttons)."""
    icon_map = {
        "refresh": "icons/update_sync_reload_reset_icon_229508.svg",
        "edit": "icons/edit_square_icon_184295.svg",
        "delete": "icons/delete_icon_184291.svg",
    ...
    if icon.isNull():
        return icon
    return _recolor_icon(icon, QColor(hex_color))
